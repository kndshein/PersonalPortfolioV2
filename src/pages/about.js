        ...
        <div className="about-page">
          <div className="about-text">
            ...
            <p>
              ...
              Beloit College, a small liberal arts college in Wisconsin, I
              worked in the chemical industry before pursuing software
              engineering full-time. <br />
              <br />
          ...
          <div className="about-form-container">
            ...
            <div className="about-form">
              <form name="submit-to-google-sheet" autoComplete="off">
                ...
                <button id="about-form-button" type="submit">
                  Submit
                </button>
              </form>
